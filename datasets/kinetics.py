        ...
        if self.mode == 'train':
            ...
            if args.num_sample > 1:
                ...
                for _ in range(args.num_sample):
                    ...
                    if self.args.data_set == 'UCF101':
                        label = int(self.label_array[index])-1
                    else:
                        label = self.label_array[index]
                    frame_list.append(new_frames)
                    label_list.append(label)
                    index_list.append(index)
                return frame_list, label_list, self.dataset_samples[index], {}
            else:
                buffer = self._aug_frame(buffer, args)

            return buffer, (int(self.label_array[index])-1) if self.args.data_set=='UCF101' else self.label_array[index], self.dataset_samples[index], {}
            ...
            return buffer, (int(self.label_array[index])-1) if self.args.data_set=='UCF101' else self.label_array[index], sample.split("/")[-1].split(".")[0]
            ...
            buffer = self.data_transform(buffer)
            return buffer, (int(self.test_label_array[index])-1) if self.args.data_set=='UCF101' else self.test_label_array[index], sample.split("/")[-1].split(".")[0], \
                   chunk_nb, split_nb
        else:
